...
public class MessageTests {
    ...
    static Stream<Message> messages() {
        return Stream.of(
                ...
                new CreateGameMessage("test", 2, 42),
                new EntityUpdateMessage(new Entity(42, Type.CAT, "cat", new Position(1, 2), false, true, -1)),
                new GameWorldMessage(new int[][]{new int[]{1, 2, 3}, new int[]{4, 5, 6}}, List.of(new Subway(1, Color.RED, List.of(new Position(1, 2), new Position(3, 4)), List.of(new Position(1, 2), new Position(3, 4)))), 42),
                new GenericErrorMessage("test"),
                new PlayerNameMessage("test"),
